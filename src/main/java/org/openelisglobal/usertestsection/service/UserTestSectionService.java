...
//    // bugzilla 2371
//    List<Test> getPageOfTestsBySysUserId(HttpServletRequest request, int startingRecNo, String doingSearch,
//            String searchStr) throws LIMSRuntimeException;

//    List<TestSection> getAllUserTestSections(HttpServletRequest request) throws LIMSRuntimeException;
...
//    List<SamplePdf> getSamplePdfList(HttpServletRequest request, Locale locale, String sampStatus, String humanDomain)
//            throws LIMSRuntimeException;

    // bugzilla 2433
//    List<Analysis> getAnalyses(HttpServletRequest request, List<Object> analyses, List<Object> testSections)
//            throws LIMSRuntimeException;
}

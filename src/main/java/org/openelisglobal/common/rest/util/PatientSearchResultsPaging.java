...
public class PatientSearchResultsPaging {
    ...
    public void setDatabaseResults(HttpServletRequest request, PatientSearchResultsForm form, List<PatientSearchResults> results)
    ...
    private static class PatientSearchResultsPageHelper implements IPageDivider<List<PatientSearchResults>>, IPageUpdater<List<PatientSearchResults>>, IPageFlattener<List<PatientSearchResults>> {

        @Override
        public void createPages(List<PatientSearchResults> patientSearchResults, List<List<PatientSearchResults>> pagedResults) {
        ...
        @Override
        public void updateCache(List<PatientSearchResults> cacheItems, List<PatientSearchResults> clientItems) {
